...
exports.leerTurnosFinalizados = function(usuario,res){


    db.leerTFinalizados(usuario, datos => {
        res.json(datos);
    });
...
exports.modificarHorarios = function(usuario,res){

    db.modificarH(usuario, datos => {
        res.json(datos);
    });
